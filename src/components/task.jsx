    ...
    <div className='bg-[#F6FAFF] h-[150px] p-3  border-2 border-[#0075FF] border-opacity-10 rounded-2xl'>
        ...
        <div className="mt-3 flex justify-between">
            ...
            <div className="btns flex gap-2 scale-90">
                ...
                <button className='text-sm flex gap-2 rounded-lg p-2 justify-center items-center border-2 border-[#0075ff]'>
                ...
                <button className='text-sm flex gap-2 rounded-lg p-2 justify-center items-center border-2 border-[#BA4A4A]'>
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">

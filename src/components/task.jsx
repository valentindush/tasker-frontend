  ...
  return (
    <div className='bg-[#F6FAFF] h-[120px] p-3  border-2 border-[#0075FF] border-opacity-10 rounded-2xl'>
        <div className="flex items-start justify-between">
            <div className="">
                <h2 className='text-[15px] text-gray-700'>{task.title}</h2>
        ...
        <div className="flex justify-between">
            ...
            <div className="btns flex gap-2 scale-90">
                ...
                <button className='text-sm flex gap-2 rounded-lg p-2 justify-center items-center border border-[#0075ff] hover:scale-95 transition duration-300 ease-out'>
                ...
                <button className='text-sm flex gap-2 rounded-lg p-2 justify-center items-center border border-[#BA4A4A] hover:scale-95 transition duration-300 ease-out'>
                    <svg width="15" height="15" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">

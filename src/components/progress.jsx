    ...
    <div className='progress flex items-center justify-center pt-12'>
        <div className="circle scale-[1.35] relative">
            ...
            <defs>
                ...
                <stop offset="0%" stop-color="#1375ff" />
                <stop offset="100%" stop-color="#5a57f3" />
                </linearGradient>
            </defs>
            <circle  className='fill-white stroke-[20px]  stroke-[#eceff3]' cx="80" cy="80" r="70" stroke-linecap="round" />
            <circle stroke='url(#GradientColor)' strokeDasharray={"472"} strokeDashoffset={`${472-(472*props.value/100)}`} className='fill-white stroke-[20px] stroke-dash ' cx="80" cy="80" r="70" stroke-linecap="round" />
